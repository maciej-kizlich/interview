...
public class RemindUserOfBookReturnDateJob extends AbstractScheduledJob<List<Object[]>>{

	@Override
	public List<Object[]> getJobDatasource() {
		
		Integer numberOfDays = Integer.valueOf(adminRepository.getConfigByName("book.return.reminder.in.days").getValue());
		DateTime dateInFuture = timeProvider.getCurrentTime().plusDays(numberOfDays);
		
		List<Object[]> results = bookOrderRepository.findBooksAndUsersWithOrdersExpiresOn(dateInFuture);
		return results;
	}
	
	@Override
	public void executeJob(List<Object[]> jobDatasource) {
